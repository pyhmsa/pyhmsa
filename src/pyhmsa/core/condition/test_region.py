...
class TestRegionOfInterest(unittest.TestCase):
    ...
    def testset_channels(self):
        self.assertRaises(ValueError, self.roi.set_channel, None, 636)
        self.assertRaises(ValueError, self.roi.set_channel, 556, None)
        self.assertRaises(ValueError, self.roi.set_channel, -1, 636)
        self.assertRaises(ValueError, self.roi.set_channel, 636, 556)
